...
Subjects_train.txt/subjects_test.txt:  Each row identifies the subject who performed the 
...
2. Extracted only the measurements on the mean and standard deviation for each measurement.
   Changed some names slightly to force unique column names. does not affect legibility
3. Used descriptive activity names to name the activities in the data set. changed column description 
   to make more understandable.
4. Appropriately labeled the data set with descriptive variable names by changing the activitys from an numeric
   value to a descriptive one... I.e. 1 was changed to "WALKING"
5. From the data set in step 4, creates a second, independent tidy data set with the average of each variable 
   for each activity and each subject. Ordered the data and grouped it by person and activity. then summarized
   or averaged the variables.
